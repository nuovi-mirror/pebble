 ...
 */
static struct name* namecat(const char* s, const char* t, int create) {
  char* p;
  struct name* np;
 ...
 * is 'base'.
 */
struct name* dyndep0(char* base, const char* tsuff, struct rule* infrule) {
  char* psuff;
...
#define MACROS_2024 "CC=c17\n"

#define MACROS_EXT "CC=cc\n"
