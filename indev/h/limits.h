...
/* allocator-related */
#define limits_allocator_temp_maxmem \
  8 * 1024 * 1024 /* max mem in temp allocator */
#define limits_allocator_persist_maxmem \
  32 * 1024 * 1024 /* max mem in persist allocator */
#define limits_allocator_scratch_maxmem \
  6 * 1024 * 1024 /* max mem in scratch allocator */

/* instruction-related */
#define limits_instructions_max \
  500000 /* max number of instructions that can be executed */
...
#define limits_instructions_varnamesize \
  64 /* number of chars for a variable name */

/* stack-related */
#define limits_stack_callStack_cap 512
#define limits_stack_callStack_frameSize (sizeof(StackFrame))
#define limits_stack_callStack_size \
  (limits_stack_callStack_cap * limits_stack_callStack_frameSize)

/* function-related */
#define limits_functions_max \
  5000 /* max number of functiosn that can be defined */
...
#define limits_instruction_new_destsize \
  limits_instructions_varnamesize /* size in bytes of the dest buffer */
#define limits_instruction_new_datasize \
  32 /* size in bytes of the data buffer */
